...
public class PracticeAccordion extends BaseTest {
    ...
    public void showTextSection1() {
        ...
        String textSection1 = driver.findElement(By.xpath("//div/p[.='Mauris mauris ante, blandit et, ultrices a, suscipit eget, " +
                "quam. Integer ut neque. Vivamus nisi metus, molestie vel, gravida in, condimentum sit amet, nunc. Nam a nibh. " +
